...
CREATE TABLE TBL_CLASIFICACIONES(
  COD_CLASIFICACIONES  BIGINT       PRIMARY KEY AUTO_INCREMENT  COMMENT 'CODIGO ID DE LA LLAVE PRIMARIA'
...
,EST_SUBCUENTAS('INGRESADA', 'PENDIENTE', 'PROCESADA')            COMMENT 'DESCRIPCION DEL ESTADO EN EL QUE SE ENCUENTRA LA TRANSACCION'
