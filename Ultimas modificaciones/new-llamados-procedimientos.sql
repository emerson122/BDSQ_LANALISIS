...
/*Ingresar un Objeto*/
CALL PRC_OBJETOS('HOME', 'PANTALLA PRINCIPAL', 'PANTALLA', 1, 1);
CALL PRC_OBJETOS('LOGIN', 'PANTALLA DE INICIO DE SESION', 'PANTALLA', 1,   1);
CALL PRC_OBJETOS('REGISTRO', 'PANTALLA DE REGISTRO DE USUARIO EXTERNA', 'PANTALLA', 1, 1);
CALL PRC_OBJETOS('CUENTAS', 'PANTALLA DE REGISTRO DE CUENTAS', 'PANTALLA', 1,  1);
CALL PRC_OBJETOS('SUBCUENTAS', 'PANTALLA DE REGISTRO DE SUBCUENTAS', 'PANTALLA', 1,    1);


/*Ingresar aqui sus pantallaaaass*/

CALL PRC_OBJETOS('LIBRODIARIO', 'PANTALLA DE LOS LIBROS DIARIOS', 'PANTALLA', 1, 1);
CALL PRC_OBJETOS('PERIODO', 'PANTALLA DE GESTION DE PERIODO', 'PANTALLA', 1, 1);
CALL PRC_OBJETOS('LIBROMAYOR', 'PANTALLA DE LOS LIBROS MAYORES', 'PANTALLA', 1, 1);
CALL PRC_OBJETOS('BALANCE', 'PANTALLA DE LOS LIBROS MAYORES', 'PANTALLA', 1, 1);
CALL PRC_OBJETOS('RESULTADOS', 'PANTALLA DE LOS LIBROS MAYORES', 'PANTALLA', 1, 1);
CALL PRC_OBJETOS('CLASIFICACION', 'PANTALLA DE LAS CLASIFICACIONES', 'PANTALLA', 1, 1);
CALL PRC_OBJETOS('GRUPOS', 'PANTALLA DE REGISTRO DE GRUPOS', 'PANTALLA', 1, 1);
CALL PRC_OBJETOS('PERSONAS', 'PANTALLA DE REGISTRO DE PERSONAS', 'PANTALLA', 1, 1);
CALL PRC_OBJETOS('OBJETOS', 'PANTALLA DE LOS OBJETOS', 'PANTALLA', 1, 1);

/* SEGURIDAD */
CALL PRC_OBJETOS('USUARIOS', 'PANTALLA DE USUARIOS', 'PANTALLA', 1, 1);
CALL PRC_OBJETOS('ROLES', 'PANTALLA DE ROLES', 'PANTALLA', 1, 1);
CALL PRC_OBJETOS('PERMISOS', 'PANTALLA DE PERMISOS', 'PANTALLA', 1, 1);
CALL PRC_OBJETOS('BITACORAS', 'PANTALLA DE BITACORAS', 'PANTALLA', 1, 1);
CALL PRC_OBJETOS('PARAMETROS', 'PANTALLA DE PARAMETROS', 'PANTALLA', 1, 1);
CALL PRC_OBJETOS('PREGUNTAS', 'PANTALLA DE PREGUNTAS', 'PANTALLA', 1, 1);
CALL PRC_OBJETOS('AJUSTES', 'PANTALLA DE AJUSTES', 'PANTALLA', 1, 1);



/*Ingresar un Usuario Con control absoluto*/
CALL PROC_MS_USR_INSERTAR('ROOT','TecnoBot ', 1, '2022-02-02', 1, 1, 'tecnobot@gmail.com', 'Cual es tu color favorito?','verde' , ' 137772b7ecb263dc707ab445c56c0181');
...
Call PRC_MS_PARAMETROS('ADMIN_INTENTOS_INVALIDOS', '3', "TECNOBOT", now(), 1, 1); -- CANTIDAD DE INTENTOS ANTES DE INICIAR SESION
Call PRC_MS_PARAMETROS('ADMIN_CANT_PREG', '2', "TECNOBOT", now(), 1, 1); -- CANTIDAD MAXIMO DE PREGUNTAS
Call PRC_MS_PARAMETROS('ADMIN_PREGUNTAS', '2', "TECNOBOT", now(), 1, 1); -- PARAMETRO DE PREGUNTAS
Call PRC_MS_PARAMETROS('IMP_UTILIDAD', '0.15', "TECNOBOT", now(), 1, 1); -- IMPUESTO 
Call PRC_MS_PARAMETROS('NOM_EMPRESA', 'HTOURS', "TECNOBOT", now(), 1, 1); -- NOMBRE DE EMPRESA
Call PRC_MS_PARAMETROS('ADMIN_NUM_REGISTROS', '4', "TECNOBOT", now(), 1, 1); -- NUMERO DE MAXIMO DE REGISTRO POR VISTA (por tabla)
Call PRC_MS_PARAMETROS('ADMIN_VIG_RECUPERACION', '30m', "TECNOBOT", now(), 1, 1); -- TIEMPO DE VIGENCIA DE RECUPERACION 30 minutos
-- Call PRC_MS_PARAMETROS('ADMIN_VIG_RECUPERACION', '1d', "TECNOBOT", now(), 1, 1); -- TIEMPO DE VIGENCIA DE RECUPERACION un dia
Call PRC_MS_PARAMETROS('ADMIN_CORREO', 'systemhtours@gmail.com', "TECNOBOT", now(), 1, 1); -- CORREO DE ENVIO
Call PRC_MS_PARAMETROS('ADMIN_APP_PASSWORD', 'kmbyyqvcgkxfpluj', "TECNOBOT", now(), 1, 1); -- CONTRASENA DE APLICACION DE CORREO
/*
----------------------------------------------------------------
*/
