...
CALL PRC_OBJETOS('PARAMETROS', 'PANTALLA DE LAS OBJETOS', 'PANTALLA', 1, '');
...
call PRC_INSERT_PERMISOS(1, 10, '1', '1', '1', '1'); -- TODOS LOS PERMISOS PARA ROL ADMINISTRADOR EN PANTALLA DE PARMETROS
