...
CALL PRC_LIBDIARIO('bancos', 'EFECTIVO', 2000, 0, 1, 1);


/* INSERTAR DATOS SOLO DE CUENTA SIN SUBCUENTA */
CALL PRC_LIBDIARIO('bancos', 'EFECTIVO', 2000, 0, 2, 1);


/* INSERTAR EN LIBRO MAYOR */
CALL PRC_LIBROS_MAYORES(1, 1, '1.1', 'BANCOS', 200, 200, '2022-09-09', 1, 1);



/* BALANCE GENERAL ACTIVOS */
CALL INS_BAL_GENERAL('HTOURS', 'ACTIVO', 1);
/* BALANCE GENERAL PASIVOS */
CALL INS_BAL_GENERAL('HTOURS', 'PASIVO', 2);
/* BALANCE GENERAL PATRIMONIOS */
CALL INS_BAL_GENERAL('HTOURS', 'PATRIMONIO', 3);
