...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SYSTEMHTOURS`.`PROC_MS_USR_SELECCIONAR`(
/*
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SYSTEMHTOURS`.`PROC_MS_USR_ELIMINAR`(
  /*
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SYSTEMHTOURS`.`PROC_MS_USR_INSERTAR`(
/*
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SYSTEMHTOURS`.`PROC_MS_USR_ACTUALIZAR`(
/*
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SYSTEMHTOURS`.`PROC_MS_USR_MODF_CONTRA`(
  /*
