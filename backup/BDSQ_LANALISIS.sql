...
CREATE TABLE TBL_PERSONAS(
  ...
  ,IDENTIDAD               VARCHAR(255) NOT NULL            COMMENT 'LA INDENTIDAD DE LA PERSONA'
  ,NOM_PERSONA             VARCHAR(255) NOT NULL            COMMENT 'NOMBRE DE LA PERSONA'
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='TABLA MS PREGUNTA';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='TABLA MS PREGUNTA USUARIO';
...
CREATE TABLE `TBL_MS_USR` (
  ...
  `EST_USR` enum('BLOQUEADO','ACTIVO','INACTIVO','NUEVO') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'ACTIVO' COMMENT 'ESTADO USUARIO',
  `COD_ROL` bigint(20) DEFAULT NULL COMMENT 'CODIGO ROL',
  `FEC_ULT_CONN` date NOT NULL DEFAULT '0000-00-00' COMMENT 'FECHA ULTIMA CONEXION',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='TABLA MS USUARIO';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='TABLA MS CONTRASEÑA';
...
CREATE TABLE `TBL_MS_BITACORA_USR` (
  ...
  `USR_FEC_CREA` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'USUARIO FECHA CREADO',
  `USR_FEC_MODF` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'USUARIO FECHA MODIFICADO',
  ...
  `CONTRA_FEC_CREA` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'CONTRASEÑA FECHA CREADO',
  `CONTRA_FEC_MODF` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'CONTRASEÑA FECHA MODIFICADA',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='TABLA MS BITACORA USR';
